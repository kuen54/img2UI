#!/usr/bin/env python3
"""v8-B: gpt-image-2-official + quality=high + white-bg prompt (v6 case).
Same element list prompt as v8-A but with white background instructions.
"""
import base64
import json
import os
...
PROMPT = (
    ...
    "请你把这些元素从这张图里提取出来，单独生成纯白色背景的 PNG 图片（不要透明背景），"
    "元素之间不要重叠，放在白色画布上互不干扰。"
    "同主题的 icon 可以放在一张图里来生成，以提升效率。"
)

OUT_TAG = "v8-B-official-white"
...
def main():
    ...
    print("[1/3] Submitting (official, white, quality=high)...")
