#!/usr/bin/env python3
"""v7 Step 1-4: Generate transparent-background layout image via apimart.
Use natural Chinese description with specific element list (from Gemini Pass 1 v3),
no rules/constraints, no bbox/JSON.
"""
import base64
import json
import os
...
def main():
    ...
    out_submit = os.path.join(OUT_DIR, "v7-layout-submit.json")
    out_poll = os.path.join(OUT_DIR, "v7-layout-poll.json")
    out_img = os.path.join(OUT_DIR, "v7-layout.png")
